...
class CarRacing:
    ...
    def racing_window(self):
        ...
        pygame.display.set_caption('Car Race -- Harshit')
        self.run_car()
    ...
    def display_credit(self):
        ...
        text = font.render("Harshit Agrawal", True, self.white)
        self.gameDisplay.blit(text, (600, 540))
        text = font.render("Harshitde21@gmail.com", True, self.white)
